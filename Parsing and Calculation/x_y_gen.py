...
def calc_features_imu_only(frame):
    acc_x = frame["acc_x"]
    acc_y = frame["acc_y"]
    acc_z = frame["acc_z"]
    gyro_x = frame["gyro_x"]
...
def gen_xy(dances, X_file, y_file):
    ...
    for dance in dances:
        ...
        for item in segments_dance:
            ...
            feature_frame = calc_features_imu_only(item)
...
if __name__ == "__main__":
    dance_files = "all_dances_5.txt"
    X_file = "X_train_new_fs_45.txt"
    y_file = "y_train_new_fs_45.txt"
